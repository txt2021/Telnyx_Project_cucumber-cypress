Feature: Sign Up page
    ...
    Scenario: TC01 - Should enter incorrect email in "work email" field in "Sign up" form
    ...
    Scenario: TC03 - Should enter equal to 11 characters password in "Password" field in "Sign up" form
        Given A user open main Telnyx page
        When A user clicks on "Sign Up" button
     ...
     Scenario: TC02,TC04 - Should enter equal to 12(13) characters password in "Password" field in "Sign up" form
        Given A user open main Telnyx page
        When A user clicks on "Sign Up" button
