...
function retrieveInternalProperties() {
    return Cypress.env(constants_1.INTERNAL_PROPERTY_NAME);
}
...
function createPickle(context, scenario, pickle) {
    ...
    const internalEnv = { [constants_1.INTERNAL_PROPERTY_NAME]: internalProperties };
